...
bool guardaPaciente::existePaciente(int ID) {
    string path = "Pacientes/Paciente" + ID;
...
bool guardaPaciente::registrarPaciente(const Paciente& paciente) {
    ...
    std::string path = "Pacientes/Paciente" + std::to_string(paciente.getID());
...
Paciente guardaPaciente::extraerInfoPaciente(int ID) {
    std::string path = "Pacientes/Paciente" + std::to_string(ID) + "/info.txt";
...
bool guardaPaciente::crearExpediente(int ID) {
    std::string ruta = "Pacientes/Paciente"+ std::to_string(ID) +"/ExpedienteClinico.bin";
...
bool guardaPaciente::guardarConsulta(const Paciente& paciente, const ConsultaMedica& consulta) {
    ...
    std::string ruta = "Pacientes/Paciente"+ std::to_string(paciente.getID()) +"/ExpedienteClinico.bin";
...
bool guardaPaciente::borrarExpediente(int ID) {
    return fs::remove("Pacientes/Paciente" + std::to_string(ID) + "/expediente.bin");
}

bool guardaPaciente::borrarPaciente(int ID) {
    return fs::remove_all("Pacientes/Paciente" + std::to_string(ID));
}
