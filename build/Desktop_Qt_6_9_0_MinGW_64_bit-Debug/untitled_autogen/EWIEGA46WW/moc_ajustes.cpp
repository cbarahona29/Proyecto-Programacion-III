...
template <> constexpr inline auto Ajustes::qt_create_metaobjectdata<qt_meta_tag_ZN7AjustesE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "abrirEliminarCuentas",
        "regresarAlMenu"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'abrirCrearCuentas'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'abrirCambiarContrasena'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'abrirEliminarCuentas'
...
void Ajustes::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->abrirCrearCuentas(); break;
        case 1: _t->abrirCambiarContrasena(); break;
        case 2: _t->abrirEliminarCuentas(); break;
        case 3: _t->regresarAlMenu(); break;
        default: ;
        }
    }
    (void)_a;
