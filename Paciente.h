...
private:
    ...
    bool Existe; // Moved to private section
...
public:
    ...
    bool getExiste() const { return Existe; } // Added getter for Existe
    ...
    void setExiste(bool existe) { this->Existe = existe; } // Added setter for Existe
